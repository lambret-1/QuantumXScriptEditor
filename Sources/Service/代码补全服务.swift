...
enum 代码补全服务 {
    ...
    static let 全部候选项: [代码补全项] = [
        ...
        代码补全项(触发词: "$httpClient", 插入代码: "$httpClient", 中文说明: "HTTP客户端，支持 get/post/put/delete 异步请求", 分类: .全局对象),
