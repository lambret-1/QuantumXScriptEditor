...
enum 代码键盘数据 {
    ...
    static let 圈X按钮: [键盘按钮数据] = [
        ...
        键盘按钮数据(显示文本: "done响应", 插入文本: "$done({ body: $response.body })", 字体大小: 10),
        键盘按钮数据(显示文本: "done请求", 插入文本: "$done($request)", 字体大小: 10),
        ...
        键盘按钮数据(显示文本: "修改响应体", 插入文本: "$done({ body: '' })", 字体大小: 10),
